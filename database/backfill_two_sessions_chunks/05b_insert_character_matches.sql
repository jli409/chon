-- Insert rebuilt character_matches from tag_statistics for the two target sessions.
-- Run 05a_delete_character_matches.sql before this file.
-- Run 04b_apply_q25_bonus.sql before this file so Q25 can be read from tag_statistics.
...
chars AS (
  ...
  FROM (VALUES
    ...
    character_id,
    sa_lo, sa_hi, de_lo, de_hi, si_lo, si_hi,
    er_lo, er_hi, ob_lo, ob_hi, ce_lo, ce_hi
  )
),
metrics AS (
  SELECT
